...
pa_button = Button(root, text="Add Property", bg='#666666', fg='white', font=('Orbitron', 20, 'bold'), width=20,
                   command=click_addproperty)
pa_button.pack(pady=5)
pmodify_button = Button(root, text="Modify Property", bg='#666666', fg='white', font=('Orbitron', 20, 'bold'), width=20,
                   command=click_modifyproperty)
pmodify_button.pack(pady=5)
